...
class FullMetaDatasetH5(torch.utils.data.Dataset):
    def __init__(self, args, split=Split["TRAIN"], source=None, transform_type=None):
        super().__init__()
        ...
        # NOTE: Because the data feeding method is changed, there's no reason to avoid fixing the ways.
        ...
        self.transforms = get_transforms(
            data_config, split, transform_type=transform_type
        )
