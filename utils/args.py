...
def get_args_parser():
    ...
    parser.add_argument(
        "--num_adapters", default=1, type=int, help="Number of adapter tokens"
    )
    parser.add_argument(
    ...
    # MAML parameters
    parser.add_argument(
        "--inner_steps", default=5, type=int, help="Number of inner loop steps"
    )
    parser.add_argument(
        "--inner_eval_steps",
        default=10,
        type=int,
        help="Number of inner loop steps for evaluation",
    )
    parser.add_argument(
        "--inner_lr", default=0.01, type=float, help="Learning rate of inner loop"
    )
    parser.add_argument(
        "--first_order",
        action="store_true",
        help="Use first order approximation of MAML",
    )
    ...
    parser.add_argument(
        ...
        default=0.0001,
        type=float,
        help="Learning rate of contrastive learning",
    )
    parser.add_argument(
        "--contrastive_steps",
        default=5,
        type=int,
        help="Number of contrastive learning steps",
    )
    parser.add_argument(
        "--contrastive_eval_steps",
        default=10,
        type=int,
        help="Number of contrastive learning steps for evaluation",
    )
    ...
    parser.add_argument(
        "--optuna_n_trials", default=5, type=int, help="Number of trials for optuna"
    )
    parser.add_argument(
        "--optuna_study", default="", type=str, help="Name of optuna study"
    )
